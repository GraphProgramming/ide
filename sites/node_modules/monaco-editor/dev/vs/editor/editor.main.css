...
.monaco-editor .suggest-widget .monaco-list .monaco-list-row .icon.text { background-image: url(contrib/suggest/media/String_16x.svg); }
...
.monaco-editor.hc-black .suggest-widget .monaco-list .monaco-list-row .icon.text { background-image: url(contrib/suggest/media/String_inverse_16x.svg); }
